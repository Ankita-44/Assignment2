...
public class EdgeWebDriver {
	...
	public void TestMethod() throws Exception {
		driver.get(URL);
		driver.findElement(By.id("log_email")).sendKeys("7667409916");
		driver.findElement(By.id("log_password")).sendKeys("Bish@kh@1002");
		Thread.sleep(10000);
		driver.findElement(By.cssSelector("input[value='Login']")).click();
		Thread.sleep(1000);
		String title = driver.findElement(By.tagName("body")).getText();

		if (title.toLowerCase().contains("welcome Bishakha Bharti")) {
